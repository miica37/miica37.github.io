...
In the naming convention below, I will use this format: `hair1_front_c`<sup>(5)</sup>. The superscript <sup>(5)</sup> indicates there are 5 bones in this chain.

For skirts I am using another naming convention:

Skirt Example: `S01`<sup>(5)</sup> is a chain of 5 bones: `S01_01`, `S01_02`, `S01_03`, `S01_04`, `S01_end`
