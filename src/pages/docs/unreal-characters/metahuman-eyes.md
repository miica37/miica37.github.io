...
![Lia's using metahuman eyes](/images/common/metahuman-eyes/lia-metahuman-eyes-compare.webp)

You should be able to find Metahuman eye's material in this path `MetaHumans > Common > Face > LookDev > Shared > EyeMaterials` after you added Metahuman to your project.

![Metahuman's folder](/images/common/metahuman-eyes/metahuman-eyes-location.jpg)

This is the settings for Metahuman eyes material that I use on Lia's Eyes above (for example):

![Lia's Metahuman eye material settings](/images/common/metahuman-eyes/lia-metahuman-eyes-settings.jpg)

## Meryl's Case

For Meryl, if you try to use metahuman eye material on her eyes, her **right eye** is going to look a bit strange:

![Meryl's right eye is looking strange with metahuman eyes](/images/common/metahuman-eyes/meryl-metahuman-eyes-no.jpg)
...
![Meryl's metahuman eyes mesh](/images/common/metahuman-eyes/meryl-metahuman-eye-mesh2.webp)
...
![Meryl's metahuman head meshes](/images/common/metahuman-eyes/meryl-metahuman-head-meshes.jpg)
